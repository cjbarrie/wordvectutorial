...
saveRDS(glove_embedding, file = "data/wordembed/local_glove.rds")
...
Alternatively, you can visit [here](https://projector.tensorflow.org/) to see an example of one of these 3D projections. 
